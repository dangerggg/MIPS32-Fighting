...
module bus(
    ...
    // base sram
    output reg          sram1_ce_o,
    output reg          sram1_we_o,
    output reg[19:0]    sram1_addr_o,
    output reg[`RegBus] sram1_data_o,
    output reg[3:0]     sram1_sel_o,
    input wire[`RegBus] sram1_data_i,
    
    // ext sram 
    output reg          sram2_ce_o,
    output reg          sram2_we_o,
    output reg[19:0]    sram2_addr_o,
    output reg[`RegBus] sram2_data_o,
    output reg[3:0]     sram2_sel_o,
    input wire[`RegBus] sram2_data_i,
    ...
    reg             sram_ce_o;
    reg             sram_we_o;
    reg[19:0]       sram_addr_o;//********************************************************buyinggaishi 31:0???????????????????
